...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tr = input('\nHow many mode frequencies to compute?\n'); %%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
force_type = input('\nChoose between the four following type of external signal :\n - null\n - step\n - dirac \n - chirp\n','s');
...
%% Dynamic response
choice = input('\nEnter 1 for dynamic response, 2 for model reduction\n');
if choice == 1

    method = input('\nChoose 1 for mode displacement,\n 2 for mode acceleration,\n 3 for newmark\n');
    if method == 1
    ...
    %% Plot of DFFT of displacement vector at accelerometer DOFs
    four_plot = input('\nDo you wanna plot the discrete FT of the response vector? Y/N\n','s');
    if strcmp(four_plot, 'y') == 1 || strcmp(four_plot, 'Y') == 1
...
elseif choice == 2
    ...
    DOF_r_wanted = input('\n24,48 or 72 degrees of freedom retained ? ');
    
    method = input('\nEnter 1 for Guyan-Irons, 2 for Craig-Bampton\n');
